  ...
  if (!tx) {
    return (
      <div className="pt-24 pb-16 px-4 text-center">
        ...
        <Link href="/dashboard" className="text-emerald-400 hover:underline">{t('checkout:backToDashboard')}</Link>
      </div>
    );
  }
  ...
  return (
    <div className="pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto">
        <Link href="/dashboard" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-white mb-6 transition-colors">
        ...
        <div className="mt-4 text-center">
          <Link href="/dashboard/messages" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-white transition-colors">
