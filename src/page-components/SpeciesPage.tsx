      ...
      <div className="pt-24 pb-16 px-4 text-center max-w-xl mx-auto">
        ...
        <form
          onSubmit={(e) => {
            ...
            if (q) router.push(`/species/${encodeURIComponent(q)}`);
          }}
    ...
    <div className="pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <Link href="/browse" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-white transition-colors">
