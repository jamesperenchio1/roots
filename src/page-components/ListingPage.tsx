  ...
  if (!listing) {
    return (
      <div className="pt-24 pb-16 px-4 text-center">
        ...
        <Link href="/browse" className="text-emerald-400 hover:underline">{t('marketplace:listing.backToBrowse')}</Link>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-6">
            <div>
              <Link href={`/species/${speciesId}`} className="text-sm text-emerald-400 hover:underline mb-1 block">
              ...
              <div className="flex items-center justify-between">
                <Link href={`/seller/${listing.seller_id}`} className="text-sm text-zinc-500 hover:text-white transition-colors">
              ...
              {listing.species?.id && (
                <Link
                  href={`/species/${listing.species.id}#discussion`}
