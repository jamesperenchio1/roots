      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-16 bg-zinc-900/30 border border-white/5 rounded-xl p-8 text-center">
          ...
          <div className="flex justify-center gap-3">
            <Link href="/signup" className="bg-white text-black px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-zinc-200 transition-colors">
              {t('common:howItWorksPage.cta.signUp')}
            </Link>
            <Link href="/browse" className="border border-white/20 text-white px-6 py-2.5 rounded-lg text-sm hover:bg-white/5 transition-colors">
