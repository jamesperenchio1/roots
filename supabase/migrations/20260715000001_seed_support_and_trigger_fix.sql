...
BEGIN
  ...
  SET last_message_id = NEW.id::uuid,
...
-- Helper used by scripts/seed-database.cjs to wipe previous seed runs.
-- Disables the transfer immutability triggers temporarily, removes every
-- row owned by @roots.seed users, then re-enables the triggers.
